/* Welcome Screen Text */
export const WELCOME_MEETING_TITLE = "Welcome to your meeting";
export const MEETING_URL_TITLE = "Your Meeting URL";
...
export const PIN_DIALOG_TITLE = "PIN UP TO 6 VIDEOS";
export const PIN_DIALOG_EMPTY_MEETING = "You are the only one in this meeting";
